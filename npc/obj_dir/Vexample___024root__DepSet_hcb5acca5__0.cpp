...
#endif
                VL_FATAL_MT("vsrc/example.v", 45, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/example.v", 45, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/example.v", 45, "", "NBA region did not converge.");
            }
